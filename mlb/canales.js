...
`;
for(const ele of document.getElementsByClassName("giants")){ele.innerHTML=(giants)};
...
`;
for(const ele of document.getElementsByClassName("rays")){ele.innerHTML=(rays)};
...
`;
for(const ele of document.getElementsByClassName("dodgers")){ele.innerHTML=(dodgers)};
...
`;
for(const ele of document.getElementsByClassName("whitesox")){ele.innerHTML=(whitesox)};
...
`;
for(const ele of document.getElementsByClassName("astros")){ele.innerHTML=(astros)};
...
`;
for(const ele of document.getElementsByClassName("brewers")){ele.innerHTML=(brewers)};
...
`;
for(const ele of document.getElementsByClassName("athletics")){ele.innerHTML=(athletics)};
...
`;
for(const ele of document.getElementsByClassName("redsox")){ele.innerHTML=(redsox)};
...
`;
for(const ele of document.getElementsByClassName("padres")){ele.innerHTML=(padres)};
...
`;
for(const ele of document.getElementsByClassName("yankees")){ele.innerHTML=(yankees)};
...
`;
for(const ele of document.getElementsByClassName("reds")){ele.innerHTML=(reds)};
...
`;
for(const ele of document.getElementsByClassName("bluejays")){ele.innerHTML=(bluejays)};
...
`;
for(const ele of document.getElementsByClassName("phillies")){ele.innerHTML=(phillies)};
...
`;
for(const ele of document.getElementsByClassName("mariners")){ele.innerHTML=(mariners)};
...
`;
for(const ele of document.getElementsByClassName("braves")){ele.innerHTML=(braves)};
...
`;
for(const ele of document.getElementsByClassName("mets")){ele.innerHTML=(mets)};
...
`;
for(const ele of document.getElementsByClassName("angels")){ele.innerHTML=(angels)};
...
`;
for(const ele of document.getElementsByClassName("cardinals")){ele.innerHTML=(cardinals)};
...
`;
for(const ele of document.getElementsByClassName("indians")){ele.innerHTML=(indians)};
...
`;
for(const ele of document.getElementsByClassName("tigers")){ele.innerHTML=(tigers)};
...
`;
for(const ele of document.getElementsByClassName("cubs")){ele.innerHTML=(cubs)};
...
`;
for(const ele of document.getElementsByClassName("rockies")){ele.innerHTML=(rockies)};
...
`;
for(const ele of document.getElementsByClassName("nationals")){ele.innerHTML=(nationals)};
...
`;
for(const ele of document.getElementsByClassName("royals")){ele.innerHTML=(royals)};
...
`;
for(const ele of document.getElementsByClassName("twins")){ele.innerHTML=(twins)};
...
`;
for(const ele of document.getElementsByClassName("marlins")){ele.innerHTML=(marlins)};
...
`;
for(const ele of document.getElementsByClassName("pirates")){ele.innerHTML=(pirates)};
...
`;
for(const ele of document.getElementsByClassName("rangers")){ele.innerHTML=(rangers)};
...
`;
for(const ele of document.getElementsByClassName("orioles")){ele.innerHTML=(orioles)};
...
`;
for(const ele of document.getElementsByClassName("diamondbacks")){ele.innerHTML=(diamondbacks)};